...
public class JdbcProjectDao implements ProjectDao {
	...
	if(results.next()){
		...
		project = mapRowToProjects(results);
	}
		return project;
}
	@Override
	public List<Project> getAllProjects() {
		...
		while (results.next()) {
			Project projectResult = mapRowToProjects(results);
...
//		project.setFromDate(results.getDate("from_date"));
//		project.setToDate(results.getDate("to_date"));
		return project;
	}
